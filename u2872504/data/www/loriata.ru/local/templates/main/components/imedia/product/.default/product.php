...
$APPLICATION->SetDirProperty("class", "product-card");
...
<div class="product-card__page">
    ...
    if ($elementId > 0) {
        $arFilterRecommendProducts = 'arFilterRecommendProducts';
        if ($GLOBALS[$arFilterRecommendProducts]) {
            $APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    'FILTER_NAME' => $arFilterRecommendProducts,
                    'HIDE_NOT_AVAILABLE' => $arParams['HIDE_NOT_AVAILABLE'],
                    'HIDE_NOT_AVAILABLE_OFFERS' => $arParams['HIDE_NOT_AVAILABLE_OFFERS'],
                    'IBLOCK_ID' => $arParams['IBLOCK_ID'],
                    'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
                    ...
                    'PRODUCT_PROPS_VARIABLE' => $arParams['PRODUCT_PROPS_VARIABLE'],
                    'PRODUCT_QUANTITY_VARIABLE' => $arParams['PRODUCT_QUANTITY_VARIABLE'],
                    'PRODUCT_ROW_VARIANTS' => '[{"VARIANT":"0","BIG_DATA":false},{"VARIANT":"0","BIG_DATA":false},{"VARIANT":"0","BIG_DATA":false},{"VARIANT":"0","BIG_DATA":false},{"VARIANT":"0","BIG_DATA":false},{"VARIANT":"0","BIG_DATA":false},{"VARIANT":"0","BIG_DATA":false}]',
                    'PRODUCT_SUBSCRIPTION' => $arParams['PRODUCT_SUBSCRIPTION'],
                    ...
                    'SLIDER_TITLE' => Loc::getMessage('CATALOG_RECOMMEND_PRODUCTS'),
                    'SLIDER_ID' => 'recommend-goods-slider'
                ),
                $component
            );
        }

        $arFilterSimilarProducts = 'arFilterSimilarProducts';
        if ($GLOBALS[$arFilterSimilarProducts]) {
            $APPLICATION->IncludeComponent(
                'imedia:catalog.section',
                'slider',
                array(
                    ...
                    'ELEMENT_SORT_ORDER2' => 'desc',
                    'ENLARGE_PRODUCT' => $arParams['LIST_ENLARGE_PRODUCT'],
                    'FILTER_NAME' => $arFilterSimilarProducts,
                    'HIDE_NOT_AVAILABLE' => $arParams['HIDE_NOT_AVAILABLE'],
                    'HIDE_NOT_AVAILABLE_OFFERS' => $arParams['HIDE_NOT_AVAILABLE_OFFERS'],
                    'IBLOCK_ID' => $arParams['IBLOCK_ID'],
                    'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
                    ...
                    'COMPOSITE_FRAME_MODE' => 'A',
                    'COMPOSITE_FRAME_TYPE' => 'AUTO',
                    'SLIDER_TITLE' => Loc::getMessage('CATALOG_SIMILAR_PRODUCTS'),
                    'SLIDER_ID' => 'similar-goods-slider'
                ),
                $component
            );
        }
