...
$APPLICATION->SetPageProperty('title-type', 'catalog-section');
...
<div class="catalog__inner">
    <div class="aside-filters">
        <?php if($arResult['VARIABLES']['SECTION_VIRTUAL']): ?>
            <?php if(!empty($arResult['VARIABLES']['SECTIONS'])):?>
                <?php
                $APPLICATION->IncludeComponent(
                    'imedia:section.virtual.menu.aside',
                    '.default',
                    [
                        'SELECTED_SECTION_ID' => $arCurSection['ID'],
                        'SECTIONS' => $arResult['VARIABLES']['SECTIONS'],
                        'SECTION_APPEND_PATH' => $arResult['VARIABLES']['SECTION_APPEND_PATH']
                    ],
                    false,
                    ['HIDE_ICONS' => true]
                )
    ...
    <div class="catalog__body">
        <div class="catalog__filters">
            ...
            <?php $APPLICATION->ShowViewContent('section-mobile-menu');?>
		...
		<?//echo $arParams["ELEMENT_SORT_FIELD"].' '.$arParams["ELEMENT_SORT_FIELD2"]?>
        <?php $APPLICATION->IncludeComponent(
...
<script type="text/javascript">
    (window["rrApiOnReady"] = window["rrApiOnReady"] || []).push(function() {
        try { 
            rrApi.categoryView(<?= json_encode($arCurSection['ID']); ?>);
        } catch(e) {}
    });
</script>
...
<?php
ob_start();
if($arResult['VARIABLES']['SECTION_VIRTUAL']){
    if(!empty($arResult['VARIABLES']['SECTIONS'])){
...
$APPLICATION->AddViewContent('section-mobile-menu', ob_get_clean());