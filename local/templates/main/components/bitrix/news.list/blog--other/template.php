...
<?php if(!empty($arResult['ITEMS'])): ?>
    <aside class="blog-text__aside aside-blog">
        <div class="aside-blog__title"><?=Loc::getMessage('T_BLOG_OTHER_TITLE')?></div>
        <div class="aside-blog__items">
            <?php foreach($arResult["ITEMS"] as $arItem):
                ...
                ?>
                <article class="blog-item aside-blog__item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
                    ...
                    <div class="blog-item__content">
                        ...
                        <?php if($arItem['PREVIEW_TEXT']):?>
                            <p class="blog-item-text aside-blog__item-text"><?=$arItem['PREVIEW_TEXT']?></p>
                        <?php endif?>
                        <?php if(false && !empty($arItem['TAGS'])):?>
                            <div class="tags">
