...
/*ZDUyZmZNWMwODAwNjlhNDY5OGIxYjQzZjFjMjE1OWQyZDc5OTc=*/$GLOBALS['____1412777173']= array(base64_decode('ZGVmaW5'.'l'));if(!function_exists(__NAMESPACE__.'\\___1319602551')){function ___1319602551($_1090219885){static $_1278384178= false; if($_1278384178 == false) $_1278384178=array('RU'.'5'.'DT'.'0R'.'F',''.'WQ==');return base64_decode($_1278384178[$_1090219885]);}};class CBXFeatures{ public static function IsFeatureEnabled($_1562302814){ return true;} public static function IsFeatureEditable($_1562302814){ return true;} public static function SetFeatureEnabled($_1562302814, $_1729555554= true){} public static function SaveFeaturesSettings($_1202712616, $_1743525659){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_1207096291){} public static function ModifyFeaturesSettings($_1207096291, $_707069034){} public static function IsFeatureInstalled($_1562302814){ return true;}} $GLOBALS['____1412777173'][0](___1319602551(0), ___1319602551(1));/**/			//Do not remove this
